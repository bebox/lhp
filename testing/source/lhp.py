...
display_scale_factor_x = 4 #display scale factor becouse original resolution is 160x90
...
display_width = 440*display_scale_factor_x #this is graphics resolution, hardcoded
...
def blit_prvi_takt(x,y):
    screen.blit(pygame.transform.scale(pic_prvi_takt, (97*display_scale_factor_x, 61*display_scale_factor_y)), (x*display_scale_factor_x, y*display_scale_factor_y))

#bliting of the second bar
def blit_drugi_takt(x,y):
    screen.blit(pygame.transform.scale(pic_drugi_takt, (96*display_scale_factor_x, 61*display_scale_factor_y)), (x*display_scale_factor_x, y*display_scale_factor_y))

#bliting of the last bar line
def blit_zadnji_takt(x,y):
    screen.blit(pygame.transform.scale(pic_zadnji_takt, (9*display_scale_factor_x, 61*display_scale_factor_y)), (x*display_scale_factor_x, y*display_scale_factor_y))

#bliting the blue border
def blit_rub(x,y):
    screen.blit(pygame.transform.scale(pic_plavi_okvir, (18*display_scale_factor_x, 90*display_scale_factor_y)), (x*display_scale_factor_x, y*display_scale_factor_y))

#bliting of clefs
def blit_kljucevi(x,y):
    screen.blit(pygame.transform.scale(pic_kljucevi, (18*display_scale_factor_x, 121*display_scale_factor_y)), (x*display_scale_factor_x, y*display_scale_factor_y))

#bliting of the cursor
def blit_cursor(x_left,y_left,x_right,y_right,sprite):
    if sprite == 0:
        screen.blit(pygame.transform.scale(list_sprite_cursor[0], (3*display_scale_factor_x, 7*display_scale_factor_y)), (x_left*display_scale_factor_x, y_left*display_scale_factor_y))
        screen.blit(pygame.transform.scale(list_sprite_cursor[1], (3*display_scale_factor_x, 7*display_scale_factor_y)), (x_right*display_scale_factor_x, y_right*display_scale_factor_y))
    elif sprite == 1:
        screen.blit(pygame.transform.scale(list_sprite_cursor[2], (3*display_scale_factor_x, 7*display_scale_factor_y)), (x_left*display_scale_factor_x, y_left*display_scale_factor_Y))
        screen.blit(pygame.transform.scale(list_sprite_cursor[3], (3*display_scale_factor_x, 7*display_scale_factor_y)), (x_right*display_scale_factor_x, y_right*display_scale_factor_Y))
    else:
        screen.blit(pygame.transform.scale(list_sprite_cursor[4], (3*display_scale_factor_x, 7*display_scale_factor_y)), (x_left*display_scale_factor_x, y_left*display_scale_factor_y))
        screen.blit(pygame.transform.scale(list_sprite_cursor[5], (3*display_scale_factor_x, 7*display_scale_factor_y)), (x_right*display_scale_factor_x, y_right*display_scale_factor_y))

#bliting of a letter
def blit_slovo(x, y, slovo):
        screen.blit(pygame.transform.scale(list_sprite_slova[slovo%range_slova], (3*display_scale_factor_x, 5*display_scale_factor_y)), (x*display_scale_factor_x, y*display_scale_factor_y))
